...
from functions import show_image  # Função para mostrar imagens
...
# Função para extrair mês e ano do nome do arquivo e usá-los na ordenação
def extract_date(file_name):
    base_name = os.path.basename(file_name)
    parts = base_name.split('_')
    month = int(parts[0])  # Primeiro elemento é o mês
    year = int(parts[1])   # Segundo elemento é o ano
    return year, month

# Ordenar os arquivos em ordem cronológica (ano, depois mês)
...
# Loop através dos arquivos raster em ordem cronológica
