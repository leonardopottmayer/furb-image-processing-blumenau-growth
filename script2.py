...
for file_path in file_paths:
    with rasterio.open(file_path) as src:
        ...
        # Converter a lista de bandas para uma imagem multicanal
        img_current = np.stack(img_bands, axis=-1)
        ...
        if previous_img is not None:
            ...
            # Converter para escala de cinza (somando as bandas e normalizando)
